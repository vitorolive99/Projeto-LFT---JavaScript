...
class varDeclIDintlistexp(varDecl):
    def __init__(self, id, int, listexp):
        self.id = id
        self.int = int
        self.listexp = listexp
...
class FalseExp(exp):
    ...
    def accept(self, visitor):
        return visitor.visitFalseExp(self)
...
class VoidOpexp(Opexp):
    def __init__(self):
        pass

    def accept(self, visitor):
        return visitor.visitVoidOpexp(self)
